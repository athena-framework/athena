...
####
{
  0 => ART::FastRegex.new "^(?|/(en|fr)/(?|admin/post(?|(*:32)|/(?|new(*:46)|(\\d+)(*:58)|(\\d+)/edit(*:75)|(\\d+)/delete(*:94)))|blog(?|(*:110)|/(?|rss\\.xml(*:130)|p(?|age/([^/]++)(*:154)|osts/([^/]++)(*:175))|comments/(\\d+)/new(*:202)|search(*:216)))|log(?|in(*:234)|out(*:245)))|/(en|fr)?(*:264))/?$",
}
####
{
