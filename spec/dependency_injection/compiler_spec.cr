...
describe Athena::DI do
  describe Athena::DI::ServiceContainer do
    describe "compiler errors" do
      pending "when trying to access a private service directly" do
      ...
      pending "when a service includes the module but is missing the annotation" do
        it "should not compile" do
      ...
      pending "when a service has a non optional service dependency but it could not be resolved" do
        it "should not compile" do
