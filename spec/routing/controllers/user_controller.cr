...
class UserController < Athena::Routing::ClassController
  ...
  @[Athena::Routing::ParamConverter(param: "user", id_type: Int64, type: User, converter: Exists)]
  ...
  @[Athena::Routing::ParamConverter(param: "user", id_type: String, type: User, converter: Exists)]
