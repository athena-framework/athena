...
private class ClassCallbackClass
  ...
  @[Assert::Callback]
  def self.validate(value : Int32, context : AVD::ExecutionContextInterface, payload : Hash(String, String)?) : Nil
  end
end
...
describe AVD::Validatable do
  ...
  describe ".validation_class_metadata" do
    ...
    it "properly registers instance method callback constraints" do
      ...
      constraints.first.should be_a AVD::Constraints::Callback(InstanceCallbackClass)
    end
    ...
    it "properly registers class method callback constraints" do
      ...
      constraints.size.should eq 1
      constraints.first.should be_a AVD::Constraints::Callback(Int32)
    end
  end
end
