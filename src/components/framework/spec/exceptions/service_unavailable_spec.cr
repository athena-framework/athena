...
describe ATH::Exceptions::ServiceUnavailable do
  describe "#initialize" do
    it "sets the message, and status" do
      exception = ATH::Exceptions::ServiceUnavailable.new "MESSAGE"
    ...
    it "sets the retry-after if given as a string" do
      exception = ATH::Exceptions::ServiceUnavailable.new "MESSAGE", "17"
      exception.headers.should eq HTTP::Headers{"retry-after" => "17"}
    end

    it "sets the retry-after if given" do
      exception = ATH::Exceptions::ServiceUnavailable.new "MESSAGE", 123
