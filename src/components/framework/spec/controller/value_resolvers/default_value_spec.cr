...
describe ATHR::DefaultValue do
  describe "#resolve" do
    it "does not have a default nor is nilable" do
      parameter = ATH::Controller::ParameterMetadata(String, TestController, 0, 0).new "foo", false, nil
    ...
    it "has a nil default value and is nilable" do
      parameter = ATH::Controller::ParameterMetadata(String?, TestController, 0, 0).new "foo", true, nil

      ATHR::DefaultValue.new.resolve(new_request, parameter).should be_nil
    end

    it "with a default value" do
      parameter = ATH::Controller::ParameterMetadata(String, TestController, 0, 0).new "foo", true, "bar"
