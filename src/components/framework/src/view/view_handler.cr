...
class Athena::Framework::View::ViewHandler
  ...
  def initialize(
    ...
    @empty_content_status = :not_found     # config.empty_content_status
    @failed_validation_status = :not_found # config.failed_validation_status
    @emit_nil = false                      # config.emit_nil?
