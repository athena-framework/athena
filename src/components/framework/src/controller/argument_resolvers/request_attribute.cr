@[ADI::Register(name: "parameter_resolver_request_attribute", tags: [{name: ATH::Controller::ArgumentResolverInterface::TAG, priority: 100}])]
...
# end
# ```
struct Athena::Framework::Controller::ArgumentResolvers::RequestAttribute
